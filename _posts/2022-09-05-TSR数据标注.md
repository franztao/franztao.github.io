...
| 表格一级属性 | 表格二级属性               | 一级分类                                            | 二级分类    | 样例                                                                                                                                                                                                                                                                                                                                 | 如何标注 |
| ------ | -------------------- | ----------------------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- |
...
| x      | x                    | is_exist_ocsr                                   | x       | x                                                                                                                                                                                                                                                                                                                                  | x    |
| x      | is_line_table        | is_vertical_line_table                          | x       | x                                                                                                                                                                                                                                                                                                                                  |      |
...
| x      | compound_list_type   | is_compound_first_coloum<br/>is_field_first_row | x       | ![](https://raw.githubusercontent.com/franztao/blog_picture/main/marktext/2022-11-23-10-47-41-image.png)                                                                                                                                                                                                                           | 机器标  |
| x      | x                    | is_compound_first_row<br/>is_field_first_coloum | x       | ![](https://raw.githubusercontent.com/franztao/blog_picture/main/marktext/2022-11-23-10-54-29-image.png)                                                                                                                                                                                                                           | 机器标  |
...
| x      | 多列为compound          | x                                               | x       | ![](https://raw.githubusercontent.com/franztao/blog_picture/main/marktext/2022-11-23-10-45-18-image.png)                                                                                                                                                                                                                           | 机器标  |
